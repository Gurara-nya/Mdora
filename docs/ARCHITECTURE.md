...
- Inline emphasis, strong text, strikethrough, highlights, code spans, links, reference links, citations, emoji shortcodes, keyboard tags, raw autolinks, CommonMark angle-bracket autolinks, email links, wiki links, tags, mentions, footnotes, images, and math markers.
