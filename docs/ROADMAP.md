...
- Pause preview parsing, inspector analysis, SwiftUI document binding writes, active preview highlighting, and editor syntax repainting during active input; commit the local editor draft and refresh only after Save/Command-S or Command-R.
