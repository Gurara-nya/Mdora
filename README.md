...
- Bounded inline parsing cache plus streaming marker, parsed heading-anchor metadata, shared inline diagnostic, document-stat collection, and precomputed nested preview task offsets reduce repeated Markdown work and broad temporary arrays across preview redraws, marker analysis, and export.
