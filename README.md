...
**Current public version:** `1.0.3` · **Channel:** Public · **Default language:** English / 中文
...
- [Release note (v1.0.3)](release-notes/v1.0.3.md)
...
- **v1.0.3（Public） Mac app bundle (zip):**
  https://github.com/Gurara-nya/Mdora/releases/download/v1.0.3/Mdora-1.0.3-macOS.zip
...
- Main focus: 2.0 preparation readiness and rendering performance stability.
- Key improvements:
  - Extended task-state compatibility for warning/blocked/review/idea/success across parser/analyzer/editor flows.
  - Added resolution-aware image preview caching and background loading for large docs.
  - Added 2.0 presets and thresholds for animation/table/diagram/math/image controls in Settings.
  - Updated release metadata and README references.

### 中文

- 发布通道：公开发布（Public）
- 核心目标：2.0 准备状态与发布一致性（任务状态兼容、预览性能与图像加载稳定性）
- 关键更新：
