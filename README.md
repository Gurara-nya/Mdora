...
- Bounded inline parsing cache plus streaming marker, shared inline diagnostic, and document-stat collection reduce repeated Markdown work and broad temporary arrays across preview redraws, marker analysis, and export.
