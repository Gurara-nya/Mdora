...
- Preview parsing and editor syntax repainting stay paused while the editor is receiving input; Save/Command-S or Command-R refreshes preview, inspector, status, and editor styling once.
