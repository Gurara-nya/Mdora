...
- Preview parsing pauses while the editor is actively receiving input and refreshes after a short idle window, so typing stays stable even in split view; Command-R can force an immediate preview, inspector, and status refresh.
