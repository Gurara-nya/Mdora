...
- Shared inline Markdown parser for preview, marker recognition, and HTML export, covering emphasis, strong text, strikethrough, highlights, inline code, links, reference links, inline images, image references, wiki links, citations, emoji shortcodes, keyboard tags, tags, mentions, footnotes, raw and angle-bracket autolinks, email links, and inline math.
...
- Inspector for outline, metadata, front matter type, block distribution, tags, mentions, wiki links, citations, emoji shortcodes, keyboard tags, links, automatic links, email links, images, image references, footnotes, highlights, math, code languages, diagrams, TODO-style tokens, comments, and callouts.
- Editor focus feedback with current-line highlight and richer Markdown syntax coloring for YAML/TOML front matter, bold, italic, highlights, citations, emoji shortcodes, keyboard tags, images, links, footnotes, URLs, emails, tables, comments, and more.
