...
- Bounded inline parsing cache plus streaming marker and missing-reference collection reduce repeated inline Markdown work and broad temporary arrays across preview redraws, marker analysis, and export.
