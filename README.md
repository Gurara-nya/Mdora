...
- Bounded inline parsing cache plus streaming marker, missing-reference, and missing-footnote collection reduce repeated inline Markdown work and broad temporary arrays across preview redraws, marker analysis, and export.
