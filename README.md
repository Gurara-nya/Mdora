...
- Bounded inline parsing cache plus streaming marker, missing-reference, missing-footnote, and document-stat collection reduce repeated Markdown work and broad temporary arrays across preview redraws, marker analysis, and export.
