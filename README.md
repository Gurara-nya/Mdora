...
- Preview parsing pauses while the editor is actively receiving input and refreshes after a short idle window, with status-bar feedback for paused, refreshing, and updated states; Command-R can force an immediate preview, inspector, and status refresh.
