...
**Current public version:** `1.0.7` · **Channel:** Public · **Default language:** English / 中文
...
- [Release note (v1.0.7)](release-notes/v1.0.7.md)
...
- **v1.0.7（Public） Mac app bundle (zip):**
  https://github.com/Gurara-nya/Mdora/releases/download/v1.0.7/Mdora-1.0.7-macOS.zip
...
- Main focus: public readiness polish for long-document rendering diagnostics and responsive performance fallback behavior.
- Key improvements:
  - Added explicit preview degradation status feedback in the status bar.
  - Kept compatibility and publish metadata synchronized for this public release.

### 中文

- 发布通道：公开发布（Public）
- 核心目标：公开可用版在长文档场景下提供性能降级可见性与响应式策略
- 关键更新：
  - 新增预览状态栏降级提示，明确展示当前长文档/减少动画/高性能模式等降级原因。
  - 保持兼容性与发布素材同步，确保版本号、下载链接与发布说明一致。
