...
- Performance-focused settings: high-performance mode, animation sync/disable controls, and animation character threshold
- Extended task token recognition (warning/blocked/review/idea/success/done)
- Dynamic About page with version/build info and direct links to repo/issues/releases
...
- 新增性能偏好设置：高性能模式、动画开关、动画字符阈值
- 扩展任务标识识别（warning/blocked/review/idea/success/done）
- About 页支持动态版本号展示（含 Build）与仓库/发布/问题页直达链接
