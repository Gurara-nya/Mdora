...
**Current public version:** `1.0.5` · **Channel:** Public · **Default language:** English / 中文
...
- [Release note (v1.0.5)](release-notes/v1.0.5.md)
...
- **v1.0.5（Public） Mac app bundle (zip):**
  https://github.com/Gurara-nya/Mdora/releases/download/v1.0.5/Mdora-1.0.5-macOS.zip
...
- Key improvements:
  ...
  - Updated public release material and release asset naming/version readiness.
...
- 关键更新：
  ...
  - 对齐发布展示信息与打包版本数据，完成 1.0.5 公共发布材料准备
