...
- Block-based live preview for headings, paragraphs with CommonMark hard line breaks, blockquotes, Obsidian/GitHub callouts with custom titles and fold markers, lists, rich task lists, GFM tables with escaped-pipe and code-span pipe handling, images, code fences, diagrams, math blocks, footnotes, definition lists, HTML blocks, and YAML/TOML/JSON front matter.
