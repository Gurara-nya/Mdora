...
- Preview parsing, inspector analysis, active preview feedback, SwiftUI document binding writes, and editor syntax repainting stay paused while the editor is receiving input; Save/Command-S or Command-R commits the local editor draft once, then refreshes preview, inspector, status, and editor styling.
