...
- Inspector for outline, metadata, front matter type, block distribution, tags, mentions, wiki links, custom heading anchors, citations, emoji shortcodes, keyboard tags, links, automatic links, email links, images, image references, footnotes, highlights, superscript, subscript, CriticMarkup review marks, math, code languages, diagrams, TODO-style tokens, comments, and callouts.
...
- Parser: MdoraCore line-oriented block parser plus shared inline parser for preview, export, metadata extraction, block distribution stats, marker detection, and diagnostics, including YAML/TOML/JSON front matter, GFM-style tables/tasks, callouts, math, diagrams, setext headings, custom heading anchors, indented code, footnotes, definition lists, highlights, superscript, subscript, CriticMarkup additions/deletions/substitutions/comments/highlights, citations, emoji shortcodes, keyboard tags, reference links, image references, raw and angle-bracket autolinks, email autolinks, and HTML comments.
