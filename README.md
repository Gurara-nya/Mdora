...
- Reference link definitions, including CommonMark titles on the following line and rejection of invalid trailing title text, abbreviation definitions, and HTML comments are parsed as visible, inspectable structures, with references and reference images resolved by CommonMark first-wins semantics plus duplicate-definition diagnostics, and abbreviations resolved in preview and HTML export.
