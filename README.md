...
- Block-based live preview for headings, paragraphs, blockquotes, Obsidian/GitHub callouts with custom titles and fold markers, lists, task lists, tables, images, code fences, diagrams, math blocks, footnotes, definition lists, HTML blocks, and YAML/TOML/JSON front matter.
