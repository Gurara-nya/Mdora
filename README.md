...
- Reference link definitions, including escaped label brackets, balanced bare destinations, CommonMark destinations or titles on following lines, and rejection of invalid labels or trailing title text, abbreviation definitions, and HTML comments are parsed as visible, inspectable structures, with references and reference images resolved by CommonMark first-wins semantics plus duplicate-definition diagnostics, and abbreviations resolved in preview and HTML export.
