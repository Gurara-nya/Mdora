...
extension MarkdownDocument {
    ...
    Start writing in Markdown. Try **bold**, *italic*, ~~strikethrough~~, ==highlight==, H~2~O, 10^2^, :sparkles:, `inline code`, <span class="badge">inline HTML</span>, #tags, @mentions, [[Knowledge Base|wiki links]], and [links](https://example.com).
